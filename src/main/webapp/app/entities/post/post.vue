<template>
  <div>
    <h2 id="page-heading" data-cy="PostHeading">
      <span v-text="$t('cmsApp.post.home.title')" id="post-heading">Posts</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('cmsApp.post.home.refreshListLabel')">Refresh List</span>
        </button>
    ...
    <div class="alert alert-warning" v-if="!isFetching && posts && posts.length === 0">
      <span v-text="$t('cmsApp.post.home.notFound')">No posts found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('title')">
              <span v-text="$t('cmsApp.post.title')">Title</span>
            ...
            <th scope="row" v-on:click="changeOrder('blog.name')">
              <span v-text="$t('cmsApp.post.blog')">Blog</span>
